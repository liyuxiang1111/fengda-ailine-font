<template>
  <div class="Userinfo-container fr boxshadow" v-loading="loading">
    <div class="title">
      <el-upload class="avatar-uploader fl" action="https://heyongqiang.work/uploadFile" :data="{userId:userinfo.useId}" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
